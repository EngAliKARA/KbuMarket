        ...
        <ul class="nav nav-pills nav-stacked nav-bracket">
            ...
            <li class="nav-parent"><a href="#"><i class="fa fa-edit"></i> <span>Ürün İşlemleri</span></a>
                <ul class="children">
                    ...
                    <li><a href="<?=base_url("Admin\Siparisler");?>"><i class="fa fa fa-suitcase"></i> <span>Siparişler</span></a></li>
                </ul>
            </li>
            <li><a href="<?=base_url("Admin\Yorumlar");?>"><i class="fa fa-comments"></i> <span>Yorumlar</span></a></li>
            <li><a href="<?=base_url("Admin\Mesajlar");?>"><i class="fa  fa-envelope"></i> <span>İletişim Mesajları</span></a></li>
            <li><a href="<?=base_url("Admin\Sayfalar");?>"><i class="fa  fa-file-text"></i> <span>Sayfalar</span></a></li>
        </ul>
    </div><!-- leftpanelinner -->
</div><!-- leftpanel -->