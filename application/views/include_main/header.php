                ...
                <ul class="customer-menu">
                    <li class="dropdown">
                        ...
                        <ul id="login-dp" class="dropdown-menu">
                            ...
                            <li><a href="<?=base_url()."Home/Mesajlar" ?>"><strong><i class="fa fa-envelope"></i>&nbsp;&nbsp;İletişim Mesajlarım</strong></a></li>
                            <li><a href="<?=base_url()."Home/Yorumlar"?>"><strong><i class="fa fa-comments"></i>&nbsp;&nbsp;Yorumlarım</strong></a></li>
