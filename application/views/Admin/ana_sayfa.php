...
<section>
    ...
    <div class="mainpanel">
        ...
        <div class="pageheader">
            <h2><i class="fa fa-home"></i> Kbu Online Shopping Admin Panel</h2>
                ...
                <div class="col-sm-12">
                    <div class="tile-navigation">
                        ...
                        <a href="<?=base_url("Admin\Mesajlar");?>" >
                            <div class="tile purple squar">
                                <div class="tile-icon"><i class="fa fa-envelope fa-5x"></i></div>
                                <div class="tile-text"><span>İletişim Mesajları</span></div>
                            </div>
                        </a>
                        <a href="<?=base_url("Admin\Sayfalar");?>" >
                            <div class="tile red squar">
                                <div class="tile-icon"><i class="fa fa-file-text fa-5x"></i></div>
                                <div class="tile-text"><span>Sayfalar</span></div>
                            </div>
                        </a>
                        <a href="<?=base_url("Admin\Siparisler");?>" >
                            <div class="tile blue wide">
                                <div class="tile-icon"><i class="fa fa-suitcase fa-5x"></i></div>
                                <div class="tile-text"><span>Siparişler</span></div>
                            </div>
                        </a>
                    </div>
                </div><!-- col-sm-12 -->
